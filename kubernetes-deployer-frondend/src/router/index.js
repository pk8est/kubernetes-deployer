...
export const constantRouterMap = [
...

  {
    ...
    children: [
      { path: 'videos', component: _import('admin/video/index'), name: 'videoList', meta: { title: 'videoList', noCache: true }},
      { path: 'create', component: _import('charts/line'), name: 'lineChart', meta: { title: 'lineChart', noCache: true }}
    ]
  },
